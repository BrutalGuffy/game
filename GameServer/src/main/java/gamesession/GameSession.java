...
public class GameSession {
    ...
    public static ArrayList<Player> getMapPlayers() { return mapPlayers; }
    public static ArrayList<Bomb> getMapBombs() { return mapBombs; }
    public static ArrayList<Wall> getMapWalls() { return mapWalls; }
    ...
    public static void addBomb(Point point) { mapBombs.add(new Bomb(point)); }
    public static void addBomb(Bomb bomb) { mapBombs.add(bomb); }
    public static void addWood(Wood brick) { mapWood.add(brick); }
    public static void addWood(Point point) { mapWood.add(new Wood(point)); }
    public static void addWall(Wall wall) { mapWalls.add(wall); }
    public static void addWall(Point point) { mapWalls.add(new Wall(point)); }
