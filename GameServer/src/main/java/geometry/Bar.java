...
public class Bar implements Collider {
    ...
    public boolean equals(Object o) {
        ...
        if (this.firstPoint.getX() == bar.secondPoint.getX() && this.firstPoint.getY() == bar.firstPoint.getY()
                && this.secondPoint.getX() == bar.firstPoint.getX() && this.secondPoint.getY() == bar.secondPoint.getY()) return true;

        if (this.firstPoint.getX() == bar.firstPoint.getX() && this.secondPoint.getY() == bar.firstPoint.getY()
                && this.secondPoint.getX() == bar.secondPoint.getX() && this.firstPoint.getY() == bar.secondPoint.getY()) return true;

        if (this.firstPoint.getX() == bar.secondPoint.getX() && this.secondPoint.getY() == bar.firstPoint.getY()
                && this.secondPoint.getX() == bar.firstPoint.getX() && this.firstPoint.getY() == bar.secondPoint.getY()) return true;
    ...
    public boolean isColliding(Collider other) {
        if (other instanceof Bar) {
            ...
            if (this.firstPoint.getX() >= bar.secondPoint.getX() || this.secondPoint.getX() <= bar.firstPoint.getX()
                    || this.firstPoint.getY() >= bar.secondPoint.getY() || this.secondPoint.getY() <= bar.firstPoint.getY()) {
                return false;
            }
            return true;
        }
